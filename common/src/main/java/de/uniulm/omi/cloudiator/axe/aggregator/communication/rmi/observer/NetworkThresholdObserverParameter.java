 ...
 */
public abstract class NetworkThresholdObserverParameter extends ThresholdObserverParameter {
    private final String servername;
    private final Integer port;

    public NetworkThresholdObserverParameter(Double threshold, FormulaOperator operator,
