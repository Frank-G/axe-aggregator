 ...
 */
public class CliMetricObserver extends ThresholdObserver {
    public CliMetricObserver(String externalId, double threshold, FormulaOperator operator) {
        super(externalId, threshold, operator);
    }

    @Override public void update(Measurement obj) {
        System.out.println("Event happened for: " + obj.getIdMonitorInstance());
    }
}
