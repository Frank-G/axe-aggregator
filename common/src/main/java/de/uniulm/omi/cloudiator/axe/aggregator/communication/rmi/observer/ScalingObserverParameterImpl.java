 ...
 */
public class ScalingObserverParameterImpl implements ScalingObserverParameter{
    ...
    public ScalingObserverParameterImpl(Double threshold, FormulaOperator operator, String servername,
