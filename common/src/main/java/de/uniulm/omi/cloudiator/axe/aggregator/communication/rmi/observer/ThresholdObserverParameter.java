 ...
 */
public abstract class ThresholdObserverParameter implements ObserverParameter {
    private final Double threshold;
    private final FormulaOperator operator;

    public ThresholdObserverParameter(Double threshold, FormulaOperator operator) {
