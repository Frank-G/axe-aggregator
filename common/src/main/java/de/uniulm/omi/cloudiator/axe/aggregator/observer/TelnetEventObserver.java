 ...
 */
public class TelnetEventObserver extends TelnetObserver {

    public TelnetEventObserver(String externalId, double threshold, FormulaOperator operator,
        String servername, Integer port) {
        super(externalId, threshold, operator, servername, port);
    }

    @Override protected String getTypePrefix() {
        return "cdo_event";
    }
}
