 ...
 */
public class ZeroMqObserverParameterImpl implements ZeroMqObserverParameter{
    ...
    public ZeroMqObserverParameterImpl(Double threshold, FormulaOperator operator, String servername, Integer port, String externalId) {
